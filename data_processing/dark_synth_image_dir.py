...
# This file randomly selects dark skin tone synthetic images to augment training data
...
# Define the paths
source_dir = '/path/to/synth/images'
target_image_dir = f'/path_to_target_dir/dark_synth_{RATIO}'
combined_csv_path = f'/path_to_target_csv_dir/dark_synth_{RATIO}.csv'
...
filtered_df = original_df[original_df['skin_tone'].isin([5,6])]
...
dark_tone_folders = [5, 6, 11, 12]
num_to_add = int(num_synth_images / 4)
