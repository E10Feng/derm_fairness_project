...
labels = {
    ...
    #ex: 'oversample_minority_0.25_none': 'Disease Oversample x 1.25',
}

print(filtered_grouped[['experiment', 'auc_mean', 'fnr_gap_mean']])
...
# Add legend
plt.legend(title='Legend', bbox_to_anchor=(0.4, 1.15), loc='upper right')

# Save the plot
save_dir = '/path/to/save/dir'
save_path = os.path.join(save_dir, 'final_oversample_disease_os_auc_vs_fnr_gap.png')
